...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_DxNaxi4i.mjs';
import { manifest } from './manifest_CalQZqmm.mjs';
...
const _args = {
    "middlewareSecret": "aad69ac8-d1ac-4e3d-adc7-b24e8d17eca7",
